...
| New or changed AI skill/subagent | Both toolchains' copies — Claude Code (`.claude/skills/`, `.claude/agents/`) and Codex CLI (`.agents/skills/`, `.codex/agents/`) — plus the table in [`AGENTS.md`](./AGENTS.md#repo-skills-and-subagents) |
