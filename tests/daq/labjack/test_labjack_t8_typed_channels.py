...
This test requires a physical LabJack T8 with a thermocouple connected, a
DAC0 -> AIN1 voltage loopback, and a FIO4 -> FIO5 digital loopback. It
...
DO_LINE, DO_ALIAS = "FIO4", "do0"
DI_LINE, DI_ALIAS = "FIO5", "di0"
