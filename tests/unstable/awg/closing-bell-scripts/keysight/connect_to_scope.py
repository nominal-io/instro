"""Closing Bell - drive a waveform on the Keysight 33521B while watching it on a scope."""
...
AWG_VISA_RESOURCE = "USB0::0x0957::0x2B07::MY52702203::INSTR"
SCOPE_VISA_RESOURCE = "USB0::0x0699::0x0105::SGVJ016092::INSTR"
DATASET_RID = None
AWG_NUM_CHANNELS = 1
SCOPE_NUM_CHANNELS = 2
CHANNEL = 1
RUN_TIME = 30
RESET_ON_START = True
...
awg = InstroAWG(
    name="KeysightAWG", driver=Keysight33521B(visa_resource=AWG_VISA_RESOURCE), num_channels=AWG_NUM_CHANNELS
)
if DATASET_RID:
