...
# Read the process value (primary feedback measurement for control)
process_value_meas = fc.get_process_value()
print(
    f"Process value in use: {list(process_value_meas.channel_data.keys())[0]} = "
    f"{list(process_value_meas.channel_data.values())[0][0]}"
)
