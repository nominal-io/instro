...
print(f"Creating a new gas mixture invalidates our cache -- requerying and looking for: {gas_mix_name}")
gastypes = device.list_gas_types()
print(f"Found {len(gastypes)}, printing matches: {[gastype for gastype in gastypes if gastype.name == gas_mix_name]}")
