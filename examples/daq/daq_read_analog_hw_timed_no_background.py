...
with daq:
    ...
    # Set the sample rate but also the number of samples we will fetch each time daq.read_batch() is called.
    daq.configure_ai_hw_sample_rate(sample_rate=100, samples_per_channel=50)
