...
with psu:
    # Set up initial state of test: current limit, then voltage, then output off
    psu.apply(voltage=0, current_limit=0.2, channel=2, enable=False)
    ...
    psu.apply(voltage=0.5, current_limit=0.2, channel=2)
