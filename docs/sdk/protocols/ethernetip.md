...
.. autosummary::
   ...
   ~instro.ethernetip.EtherNetIPDevice
```
...
.. autosummary::
   ...
   ~instro.ethernetip.ethernetip_types.EtherNetIPConfig
   ~instro.ethernetip.ethernetip_types.TimingConfig
   ~instro.ethernetip.ethernetip_types.EtherNetIPConnectionInfo
   ~instro.ethernetip.ethernetip_types.EtherNetIPRoutePath
   ~instro.ethernetip.ethernetip_types.EtherNetIPBackplaneHop
   ~instro.ethernetip.ethernetip_types.TagDef
```
