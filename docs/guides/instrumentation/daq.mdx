...
Counter channels measure edges on an input, or generate a pulse train on an output. NI-DAQmx implements every counter method below; the other drivers raise `NotImplementedError`.
