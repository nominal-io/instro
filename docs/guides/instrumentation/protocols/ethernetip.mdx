...
<Warning>
The config-driven EtherNet/IP API supports scalar tags only. If a PLC value returns a structured value, `EtherNetIP.read()` and background polling reject it.
</Warning>
