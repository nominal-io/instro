...
Any green label is selectable. Use the arrow keys to move between controls. Press Enter to select an action, Escape to close an edit prompt, and `q` to quit.
