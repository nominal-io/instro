...
The simulator runs a terminal UI while the TCP server listens in the background.

The top **PSU** panel shows the simulator identity and VISA resource string. Use the resource string when you connect driver code to the simulator.
...
Each **Channel** row shows the live state for one output.

| Section | Shows |
| --- | --- |
| Status | Output mode, output state, sense mode, protection trips, and the remove action |
| Voltage | Terminal voltage, programmed voltage, voltage limit, OVP state, and OVP level |
| Current | Output current, current limit, current range, OCP state, and OCP level |
| Probe | Sense lead resistance and the probe-resistance action |
| Load | Load resistance, series electromotive force (EMF), and load actions |

Use the highlighted action labels to edit the load model and channel settings. Use the arrow keys to move through actions. Press Enter to select an action, Escape to close an edit prompt, and `q` to quit.

### Change load resistance

Highlight **R** in the load panel and press Enter.

<img alt="PSU simulator terminal UI with load resistance highlighted" src="/images/psu-simulator-set-load.svg" />

Enter the new resistance in ohms and press Enter.

<img alt="PSU simulator terminal UI showing the load resistance prompt" src="/images/psu-simulator-set-load-prompt.svg" />

### Change series EMF

Highlight **EMF** in the load panel and press Enter.

<img alt="PSU simulator terminal UI with series EMF highlighted" src="/images/psu-simulator-set-emf.svg" />

Enter the new series voltage in volts and press Enter.

<img alt="PSU simulator terminal UI showing the series EMF prompt" src="/images/psu-simulator-set-emf-prompt.svg" />

### Change probe resistance

Highlight **Probe R** in the probe panel and press Enter.

<img alt="PSU simulator terminal UI with probe resistance highlighted" src="/images/psu-simulator-set-probe.svg" />

Enter the new probe resistance in ohms and press Enter.

<img alt="PSU simulator terminal UI showing the probe resistance prompt" src="/images/psu-simulator-set-probe-prompt.svg" />

### Change voltage limit

Highlight **V limit** and press Enter.

<img alt="PSU simulator terminal UI with voltage limit highlighted" src="/images/psu-simulator-set-voltage-limit.svg" />

Enter the new voltage limit in volts and press Enter.

<img alt="PSU simulator terminal UI showing the voltage limit prompt" src="/images/psu-simulator-set-voltage-limit-prompt.svg" />

### Change current limit

Highlight **I limit** and press Enter.

<img alt="PSU simulator terminal UI with current limit highlighted" src="/images/psu-simulator-set-current-limit.svg" />

Enter the new current limit in amps and press Enter.

<img alt="PSU simulator terminal UI showing the current limit prompt" src="/images/psu-simulator-set-current-limit-prompt.svg" />

### Change OVP level

Highlight **OVP level** and press Enter.

<img alt="PSU simulator terminal UI with OVP level highlighted" src="/images/psu-simulator-set-ovp-level.svg" />

Enter the new OVP level in volts and press Enter.

<img alt="PSU simulator terminal UI showing the OVP level prompt" src="/images/psu-simulator-set-ovp-level-prompt.svg" />

### Change OCP level

Highlight **OCP level** and press Enter.

<img alt="PSU simulator terminal UI with OCP level highlighted" src="/images/psu-simulator-set-ocp-level.svg" />

Enter the new OCP level in amps and press Enter.

<img alt="PSU simulator terminal UI showing the OCP level prompt" src="/images/psu-simulator-set-ocp-level-prompt.svg" />

Changing **V limit**, **I limit**, **OVP level**, or **OCP level** updates the simulator channel setting and runs `*RST`. The output turns off, programmed voltage and current return to zero, protection state turns off, and OVP/OCP levels return to their configured maximums.

### Remove a channel

Highlight **Remove** in the channel status section and press Enter.

<img alt="PSU simulator terminal UI with Remove highlighted" src="/images/psu-simulator-remove-channel.svg" />

### Add a channel

Highlight **+ channel** and press Enter.

<img alt="PSU simulator terminal UI with + channel highlighted" src="/images/psu-simulator-add-channel.svg" />
...
`MIN` maps to `0`. `MAX` maps to the channel setting configured in the terminal UI for that command. Do not send `MIN` or `MAX` to queries.
