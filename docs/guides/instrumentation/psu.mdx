...
```python
commands = psu.apply(voltage=12.0, current_limit=0.5, channel=1, enable=True)
```
...
```python
psu.apply(voltage=12.0, current_limit=0.5, channel=1)               # configured, output off
psu.apply(voltage=12.0, current_limit=0.5, channel=1, enable=True)  # configured and live
```
...
# Configure channel 1
psu.apply(voltage=12.0, current_limit=0.5, channel=1, enable=True)
