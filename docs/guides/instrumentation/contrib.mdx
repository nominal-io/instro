...
**Class**: `RigolDS1104Z`  
**Import**: `from instro.contrib.scope.drivers import RigolDS1104Z`  
**Tested against**: not yet verified on hardware — mocked-transport unit tests only  
**Protocol**: SCPI over USB/LAN VISA
