...
- **Simulated**: `SimulatedELoad` for use with the bundled SCPI simulator
...
For development and testing without physical hardware, Nominal Instrumentation includes a local SCPI electronic-load simulator. See [E-Load simulator](/instrumentation/eload-simulator) for the quickstart, usage notes, and supported command set.
