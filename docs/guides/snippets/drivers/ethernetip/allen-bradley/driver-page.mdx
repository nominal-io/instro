...
## Creating an [`EtherNetIPDevice`](https://nominal-io.github.io/instro/protocols/generated/instro.ethernetip.EtherNetIPDevice/) for an Allen-Bradley PLC
...
Parameters and methods specific to [`EtherNetIPDevice`](https://nominal-io.github.io/instro/protocols/generated/instro.ethernetip.EtherNetIPDevice/) can be found in the [SDK](https://nominal-io.github.io/instro/).
