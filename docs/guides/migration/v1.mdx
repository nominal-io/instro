...
<Info>
  ...
  [`legacy_naming=True`](/library/library#backwards-compatible-channel-naming-legacy_naming)
...
See [Backwards-compatible channel naming](/library/library#backwards-compatible-channel-naming-legacy_naming) for the full feature. The flag is scheduled for removal in **v2.0**. Use the window to migrate consumers.
