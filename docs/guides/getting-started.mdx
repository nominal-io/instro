...
<Columns cols={2}>
  <Card title="B&K Precision 85xx" icon="plug" href="/instrumentation/eload">
    ![](/images/equipment/BK-8550.png)
  </Card>
</Columns>
...
<Columns cols={2}>
  <Card title="Agilent/HP/Keysight 34401A" icon="gauge" href="/instrumentation/dmm">
    ![](/images/equipment/Agilent-34401A.png)
  </Card>

  <Card title="Keysight 34461A" icon="gauge" href="/instrumentation/dmm">
    ![](/images/equipment/Keysight-34461A.png)
  </Card>

  <Card title="Keithley 2400" icon="gauge" href="/instrumentation/dmm">
    ![](/images/equipment/Keithley-2400.png)
  </Card>
</Columns>
