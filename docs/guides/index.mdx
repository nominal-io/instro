...
<Columns cols={2}>
  ...
  <Card title="Arbitrary waveform generators" icon="wave-square" href="/instrumentation/arbitrarywaveformgen">
    `InstroAWG`: category-level interface and driver contract; no vendor drivers bundled yet.
  </Card>
